  ...
  event: {
    ...
    stages: [
      makeStage(1, '發芽',
        ...
        '你完成了活動限定任務，獲得體驗先鋒 V1。繼續挑戰讓小芽芽成長！',
      ),
      ...
      makeStage(2, '長葉',
        ...
        '你完成了活動限定進階任務，升級為體驗先鋒 V2。小芽芽又長大了一點！',
      ),
      ...
      makeStage(3, '開花',
        ...
        '你完成了活動限定全部任務，達成體驗先鋒 V3！小芽芽為你驕傲。',
      ),
    ],
  },
  ...
  member: {
    ...
    stages: [
      makeStage(1, '發芽',
        ...
        '你完成了會員專屬任務，獲得有機生活家 V1。繼續挑戰讓小芽芽成長！',
      ),
      ...
      makeStage(2, '長葉',
        ...
        '你完成了會員專屬進階任務，升級為有機生活家 V2。小芽芽又長大了一點！',
      ),
      ...
      makeStage(3, '開花',
        ...
        '你完成了會員專屬全部任務，達成有機生活家 V3！小芽芽為你驕傲。',
      ),
    ],
  },
  ...
  product: {
    ...
    stages: [
      makeStage(1, '發芽',
        ...
        '你完成了商品推薦任務，獲得消費高手 V1。繼續挑戰讓小芽芽成長！',
      ),
      ...
      makeStage(2, '長葉',
        ...
        '你完成了商品推薦進階任務，升級為消費高手 V2。小芽芽又長大了一點！',
      ),
      ...
      makeStage(3, '開花',
        ...
        '你完成了商品推薦全部任務，達成消費高手 V3！小芽芽為你驕傲。',
      ),
    ],
  },
}
...
export const BADGE_VERSION = {
  1: { label: 'V1', characterStage: 1 },
  2: { label: 'V2', characterStage: 2 },
  3: { label: 'V3', characterStage: 3 },
}
